...
In this final version, your program will be nothing more than a series of function definitions followed by a single function call to `portfolio_report()` at the very end(which execute all of the steps onvolved in the program).

By turning your program into a single function, It becomes easy to run it on different inputs. For exampl, try these statements interactively after running your program:
