...
* 데이터가 희소화(`sparse`)됨차원축소(Dimension Reduction)
  ...
  * Full SVD
    ...
    ![fullSVD](https://user-images.githubusercontent.com/70785000/133336507-c473917f-c589-483a-b281-65b4a55bcdca.png)

  * Compact SVD

    비대각 부분과 대각 원소가 0인 부분을 제거

    ![CompactSVD](https://user-images.githubusercontent.com/70785000/133336243-1b5e93df-e310-49ae-9174-908893ab5cc9.png)
  ...
  * 추천엔진
  * 문서 잠재 의미 분석
  * 의사(peusdo) 역행렬을 통한 모델 예측 - 역행렬을 만들어야 하는데 만들수 없는 행렬의 경우 활용
