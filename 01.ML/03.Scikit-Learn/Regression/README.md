...
식을 풀어 헤치면
$$
= \frac {1} {N} \sum_{i=1}^N y_i^2 - 2y_i(w_0 + w_1 * x_i) + w_0^2 + 2w_0 * w_1x_1 + w_1^2x_i^2
$$

$$
= \frac{1}{N}\sum_{i=1}^N y_i^2 - 2y_iw_0 - 2y_iw_1x_1 + w_0^2 + 2w_0w_1x_1 + w_1^2x_i^2
$$

$$
= \frac{1}{N} \sum_{i=1}^N -2y_i + 2w_0 + 2w_1x_1
$$

$$
= \frac {1}{N} \sum_{i=1}^{N} -2(y_i -w_0 - w_1x_1)
$$
...
$$
새로운 w_1 = 이전 w_1 - 보정계수(학습률)  \frac {1}{N}\sum_{i=1}^{N} x_i * (실제값_i - 예측값_i)
$$

$$
새로운 w_0 = 이전 w_0 - 보정계수(학습률)  \frac {1}{N}\sum_{i=1}^{N} (실제값_i - 예측값_i)
$$
